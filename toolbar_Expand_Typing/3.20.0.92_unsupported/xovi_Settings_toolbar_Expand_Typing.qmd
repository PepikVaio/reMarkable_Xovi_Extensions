SLOT xovi_Settings_Item
    INSERT {
        ...
        ~&14125623155555875541&~ {
            ...
            /* property string set_Status_01: (Values.settings_Expand_Typing.is_Enabled_Expand_Typing ? qsTr("true") : qsTr("false"))*/

            property ~&197102514&~ dictionary_Data: [
                { ~&6504315758&~: root_Expand_Typing.set_Text_01, ~&7083177691309&~: root_Expand_Typing.set_Status_01, name_File: root_Expand_Typing.set_Name_Extension + "_Settings" }
                /* ...*/
            ]
            /* ---------------------------------------------------------------------------------------------------------------------------------------------------*/
            ...
            ~&425121728314878811&~.~&214599571833&~ {
                ...
                ~&7082453764199&~: ~&12858967014938070090&~ {
                    ...
                    ~&2132408976983288956&~.~&254542253295368380&~: {
                        ...
                        root_Expand_Typing.send_Signal("signal_is_Enabled_Expand_Typing");
                    }
                }
            }
            ...
            ~&425121728314878811&~.~&6502554441&~ {
                ...
                ~&7712155293725601&~ {
                    ...
                    ~&7712922269353028&~: ~&17505001443493339609&~ {
                        ...
                        ~&254542236275632405&~: {
                            root_Expand_Typing.open_File(~&254539508423767444&~.name_File);
                        }
                    }
                }
            }
            ...
            function show_Console_Message(log_Message, ~&6504337259&~) {
                ~&5972376&~ (root_Expand_Typing.is_Debug_Mode) {
            ...
            function send_Signal(signal_Name, ...~&6503646550&~) {
                /* Signal do not exist? -> Create*/
                ~&5972376&~ (!~&5971598&~.application.hasOwnProperty(signal_Name)) {
                    ~&5971598&~.application[signal_Name] = function() {};
                    show_Console_Message("Creating signal: " + signal_Name);
                }

                /* Signal exist? -> Call with all arguments*/
                ~&5971598&~.application[signal_Name](...~&6503646550&~);
                show_Console_Message("Sending signal: " + signal_Name + (~&6503646550&~.~&7082886407723&~ > 0 ? " with arguments: " + ~&6502785411&~.~&254548178208422824&~(~&6503646550&~) : ""));
            }
        }
    }
END SLOT
