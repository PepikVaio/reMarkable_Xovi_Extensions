SLOT xovi_Settings_Item
    INSERT {
        ...
        ~&14125623155555875541&~ {
            ~&5972374&~: root_Translation

            /* Initializing variables - Main*/
            property ~&7083178290016&~ set_Label: ~&6504222003&~("Translation")
            property ~&7083178290016&~ set_Description: ~&6504222003&~("Set your custom language and customize sw keyboard.")

            property ~&7083178290016&~ set_Text_01: ~&6504222003&~(~&"7712198086779994&~)

            property ~&7083178290016&~ set_Status_01: ~&6504222003&~("")

            property ~&197102514&~ dictionary_Data: [
                { ~&6504315758&~: root_Translation.set_Text_01, ~&7083177691309&~: root_Translation.set_Status_01, name_File: root_Translation.set_Name_Extension + "_Settings" }
                /* ...*/
            ]
            /* ------------------------------------------------------------------------------------------------------------------------------------------------------*/
            ...
            property ~&7083178290016&~ set_Name_Extension: "system_Translation"
            /* --------------------------------------------------------*/
            ...
            ~&425121728314878811&~.~&214599571833&~ {
                ...
                ~&214632764553&~: root_Translation.set_Label
                ~&478136262235079021&~: root_Translation.set_Description

                /* Připraveno a se naučím přesouvat soubory nebo vypínat nastavení*/
                /* action: ArkToggleWrapper {*/
                /*     checked: Values.settings_Translation_UI.is_Enabled_Translation_UI*/
                /*     showFocus: false*/

                /*     extendedMouseArea.onPressed: {*/
                /*         Values.settings_Translation_UI.is_Enabled_Translation_UI = !Values.settings_Translation_UI.is_Enabled_Translation_UI*/
                        
                /*         // Reset values*/
                /*         Values.settings_Translation_UI.set_Language_Name = "German (beta)"*/
                /*     }*/
                /* }*/
            }
            ...
            ~&425121728314878811&~.~&6502554441&~ {
                ~&7081629735527&~.~&254529418434902000&~: ~&6504329801&~
                /* Připraveno a se naučím přesouvat soubory nebo vypínat nastavení*/
                /* visible: Values.settings_Translation_UI.is_Enabled_Translation_UI*/

                ~&7712155293725601&~ {
                    ~&214634455770&~: root_Translation.dictionary_Data
                    ...
                    ~&7712922269353028&~: ~&17505001443493339609&~ {
                        ...
                        ~&254542236275632405&~: {
                            root_Translation.open_File(~&254539508423767444&~.name_File)
                        }
                    }
                }
            }
            ...
            function show_Console_Message(log_Message, ~&6504337259&~) {
                ~&5972376&~(root_Translation.is_Debug_Mode) {
